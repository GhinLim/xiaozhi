...
#ifdef FULL_SCREEN_EMOJI
    if (full_emoji_img_ != nullptr) {
        lv_obj_del(full_emoji_img_);
    }
    if (full_emoji_container_ != nullptr) {
        lv_obj_del(full_emoji_container_);
    }
#endif
    if (display_ != nullptr) {
...
#ifdef FULL_SCREEN_EMOJI
    full_emoji_container_ = lv_obj_create(screen);
    lv_obj_set_size(full_emoji_container_, LV_HOR_RES, LV_VER_RES);
    full_emoji_img_ = lv_img_create(full_emoji_container_);
    lv_obj_align(full_emoji_img_, LV_ALIGN_CENTER, 0, 0);
#endif
}
#endif
...
void LcdDisplay::SetEmotion(const char* emotion) {
    ...
    if (it != emotions.end()) {
        if(it->text == "neutral"){
            lv_img_set_src(full_emoji_img_, &Neutral);
        }else if(it->text == "happy"){
            lv_img_set_src(full_emoji_img_, &Happy);
        }else if(it->text == "laughing"){
            lv_img_set_src(full_emoji_img_, &Laughing);
        }else if(it->text == "funny"){
            lv_img_set_src(full_emoji_img_, &Funny);
        }else if(it->text == "sad"){
            lv_img_set_src(full_emoji_img_, &Sad);
        }else if(it->text == "angry"){
            lv_img_set_src(full_emoji_img_, &Angry);
        }else if(it->text == "crying"){
            lv_img_set_src(full_emoji_img_, &Crying);
        }else if(it->text == "loving"){
            lv_img_set_src(full_emoji_img_, &Loving);
        }else if(it->text == "embarrassed"){
            lv_img_set_src(full_emoji_img_, &Embarrassed);
        }else if(it->text == "surprised"){
            lv_img_set_src(full_emoji_img_, &Surprised);
        }else if(it->text == "shocked"){
            lv_img_set_src(full_emoji_img_, &Shocked);
        }else if(it->text == "thinking"){
            lv_img_set_src(full_emoji_img_, &Thinking);
        }else if(it->text == "winking"){
            lv_img_set_src(full_emoji_img_, &Winking);
        }else if(it->text == "cool"){
            lv_img_set_src(full_emoji_img_, &Cool);
        }else if(it->text == "relaxed"){
            lv_img_set_src(full_emoji_img_, &Relaxed);
        }else if(it->text == "delicious"){
            lv_img_set_src(full_emoji_img_, &Delicious);
        }else if(it->text == "kissy"){
            lv_img_set_src(full_emoji_img_, &Kissy);
        }else if(it->text == "confident"){
            lv_img_set_src(full_emoji_img_, &Confident);
        }
    } else {
        lv_img_set_src(full_emoji_img_, &Neutral);
    }
